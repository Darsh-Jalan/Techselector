...
const Header = ({
  ...
  return (
    ...
    >
      <Container>
        <Navbar.Brand href="/home">Techselector</Navbar.Brand>
          ...
          <Nav className="mr-auto" activeKey={pathname}>
            ...
            >
              {[
                ...
                { label: 'ios', filter: 'ios' },
                { label: 'buisness-laptop', filter: 'buisness-laptop' },
                { label: 'gaming-laptop', filter: 'gaming-laptop' },
                { label: 'camera', filter: 'camera' },
            ...
            >
              {[
                { label: 'Performance', filter: 'V-High' },
                { label: 'Battery-life', filter: 'High' },
                { label: 'Display-Resolution', filter: 'Above-Average' },
                { label: 'Memory', filter: 'Average' },
                { label: 'Camera-Quality', filter: 'Below-Average' },
                { label: 'Portability', filter: 'Low' },
                { label: 'Display-Size', filter: 'V-Low' },
                      ...
                      <img
                        src={
                          getCurrentUser() === 'google'
                            ...
                            : require(`../../static/products/profileimage.jpeg`)
                        }
                        className="user-img"
                      />
                    </div>
